...
<div class="container">
  <div class="row py-5 text-center">
    <div class="col lg-3 mx-auto m-3">
      <div class="card text-white justify-content-center w-100 h-100 bg-dark mb-3">
        <div class="card-body">
  ...
  @else
    ...
    <div class="row">
      <div class="col-lg-3 mx-auto w-100">
        ...
        <a href="{{route('dashboard-index')}}" class="btn mt-3 mb-3 w-100 text-bold custom-button-buku-all">Tampilkan Semua</a>
      </div>
      ...
      <div class="col-lg-9 mx-auto w-100">
        ...
        @if ($bukus->count() == 0)
          <div class="alert alert-primary" role="alert">
            Mohon maaf buku yang Anda cari tidak ada di data kami, silahkan <a href="{{route('dashboard-index')}}" class="alert-link">cari buku</a> lain. Terima kasih.
          </div>
        @else            
          @foreach ($bukus as $buku)
            <div class="shadow border-custom-list-buku mb-5" style="background-color: #a7c5eb">
              <div class="row">
                ...
                <div class="col-lg-9">
                  ...
                  <p class="text-right mr-4 mt-5">
                    <i class="fa fa-sticky-note" aria-hidden="true" style="color: #ffd56b"></i> {{$ulasan->where('buku_id', $buku->id)->count()}} &nbsp; &nbsp;
                    <i class="fa fa-heart" aria-hidden="true" style="color: #f05454"></i> {{$suka->where('buku_id', $buku->id)->count()}}
                  </p>
                </div>
              </div>
            </div>
